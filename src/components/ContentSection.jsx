...
const ContentSection = ({ text, imageSrc, imageAlt }) => {
    return (
        <div className="flex items-center justify-center bg-custom-image bg-cover bg-center py-6 md:py-10 px-6 max-h-[620px]"
            style={{
                backgroundColor: "rgba(49, 2, 25, 1)",
                backgroundBlendMode: "overlay",
            }}>
            <div className="max-w-6xl w-full flex flex-col md:flex-row gap-6 py-6">
                <div className="text-white font-thin md:w-1/2 text-center md:text-left">
