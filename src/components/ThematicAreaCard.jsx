...
export const ThematicAreaCard = ({ join }) => {
    return (
        <div className='py-4 md:py-6 relative max-w-7xl mx-auto px-4 md:px-8 mt-2 rounded-2xl shadow-2xl shadow-black-600/90 border-t-6 border-[#640433]'>
            <p className="text-xl md:text-4xl font-bold text-[#640433] mb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-8">Thematic Areas of Focus</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                ...
                {join.map((join, index) => (
                    ...
                    >
                        ...
                        {/* Text Section */}
                        <div>
                            <h3 className="text-xl font-semibold mb-1">{join.title}</h3>
                            <p className="text-sm opacity-75">{join.description}</p>
                        </div>
                    </motion.div>
                ))}
            </div>
