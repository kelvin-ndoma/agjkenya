  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
        {/* form */}
        <div className="one">
          <p className="text-xl md:text-3xl font-bold text-start py-4">
            <span className="">Contact</span>
            <span className="text-gray-600 pl-2">Us</span>
          </p>
        ...
        <div className="two">
          ...
          <div className="contact-info">
            <p className="text-xl font-thin text-gray-600 pb-2 md:pb-3">If you have any questions, please feel free to get in touch with us via phone, text email, the form beow, or even on social media</p>
